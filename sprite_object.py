...
class SpriteObject:
    def __init__(self, game, path='assets/sprites/static/tile000.png', pos=(10.5, 3.5), scale = 0.5, shift = 0.27):
        self.game = game
...
class AnimatedSprite(SpriteObject):
    def __init__(self, game, path='assets/sprites/anim/chest/chest0.png', pos=(11.5, 3.5), scale = 0.5, shift = 0.4, anim_time = 120):
